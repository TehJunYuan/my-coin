/* 
  ...
  CoinGecko api provide the data in JSON format.
  
  Coin class is generate with quicktype.io(https://quicktype.io/), 
  because we need to convert the JSON type from CoinGecko api to dart language.

  All coin data is come from the CoinGecko api,
  references: https://www.coingecko.com/en/api/documentation 
